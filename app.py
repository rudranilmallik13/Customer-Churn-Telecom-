...
You can also : 
* Check the **GitHub Project Repository**   [![](https://img.shields.io/badge/Customer%20Churn%20Prediction-GitHub-100000?logo=github&logoColor=white)](https://github.com/rudranilmallik13/Customer-Churn-Telecom-)
...
cat_cols = input_df.select_dtypes(exclude=['number']).columns
